...
f_11: goal/okr blob type + capability bootstrap + GOKR execution engine.
...
def run_all(reviewer: str = "evolve") -> list[dict]:
    ...
    """
    tolerance = _derive_tolerance()
    print(f"── f_11: Self-Modification Cycle  (derived tolerance={tolerance:.4f})")
    ...
    print(f"\n  f_11 complete. {len(promoted)}/{len(results)} blobs promoted → manifest v1.11.0")
    return results
