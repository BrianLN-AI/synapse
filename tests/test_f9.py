...
Covers:
  ...
  - Full f_9 evolution cycle: mocked two-model pipeline, manifest v1.9.0
...
def test_full_f9_evolution_cycle() -> None:
    section("Full f_9 evolution cycle — two-model pipeline, manifest v1.9.0")
    ...
    check("at least one v1.9.0 promote event", len(promote_v9) >= 1)
