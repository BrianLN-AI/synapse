...
Covers:
  ...
  - Full f_12 evolution cycle: manifest v1.12.0
...
def test_full_f12_evolution_cycle() -> None:
    section("Full f_12 evolution cycle — blake3 hashes, manifest v1.12.0")
    ...
    check("at least one v1.12.0 promote event", len(promote_v12) >= 1)
